...
def catCFDI(catalogo):
    ...
    if catalogo.exists():
        catalogo = catalogo[0]
        return [(opc.clave_sat, opc.mostrar_como) for opc in OpcionCatalogoSAT.objects.filter(catalogo=catalogo)]
    return []
...
class OpcionCatalogoSAT(models.Model):
    ...
    catalogo = models.ForeignKey(CatalogoSAT, on_delete=models.CASCADE, related_name="opciones")
...
class Comprobante(models.Model):
    ...
    FormaPago_opcion = models.ForeignKey(OpcionCatalogoSAT, on_delete=models.SET_NULL, related_name="comprobantes_formapago", null=True, blank=True, limit_choices_to={'catalogo__idsat': 'FormaPago'})
    NoCertificado = models.CharField(max_length=20, null=True, blank=True)
    Certificado = models.TextField(null=True, blank=True)
    CondicionesDePago = models.CharField(max_length=1000, null=True, blank=True)
    SubTotal = models.DecimalField(max_digits=13, decimal_places=6)
    Descuento = models.DecimalField(null=True, blank=True, max_digits=13, decimal_places=6)
    ...
    Moneda_opcion = models.ForeignKey(OpcionCatalogoSAT, on_delete=models.SET_NULL, related_name="comprobantes_moneda", null=True, blank=True, limit_choices_to={'catalogo__idsat': 'Moneda'})
    TipoCambio = models.DecimalField(null=True, blank=True, max_digits=11, decimal_places=6)
    ...
    TipoDeComprobante_opcion = models.ForeignKey(OpcionCatalogoSAT, on_delete=models.SET_NULL, related_name="comprobantes_tipodecomprobante", null=True, blank=True, limit_choices_to={'catalogo__idsat': 'TipoDeComprobante'})
    MetodoPago = models.CharField(max_length=25, null=True, blank=True)
    MetodoPago_txt = models.CharField(max_length=250, null=True, blank=True)
    MetodoPago_opcion = models.ForeignKey(OpcionCatalogoSAT, on_delete=models.SET_NULL, related_name="comprobantes_metodopago", null=True, blank=True, limit_choices_to={'catalogo__idsat': 'MetodoPago'})
...
class CfdiRelacionados(models.Model):
    ...
    comprobante = models.ForeignKey(Comprobante, on_delete=models.CASCADE, related_name="nodo_cfdisrelacionados")
    TipoRelacion = models.CharField(max_length=25)
    TipoRelacion_txt = models.CharField(max_length=250)
    TipoRelacion_opcion = models.ForeignKey(OpcionCatalogoSAT, on_delete=models.SET_NULL, related_name="cfdisrelacionados_tiporelacion", null=True, blank=True, limit_choices_to={'catalogo__idsat': 'TipoRelacion'})
    created_by = models.ForeignKey(
        Usr, on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_by = models.ForeignKey(
...
class CfdiRelacionado(models.Model):
    ...
    cfdirelacionados = models.ForeignKey(CfdiRelacionados, on_delete=models.CASCADE, related_name="cfdisrelacionados")
...
class Emisor(models.Model):
    ...
    comprobante = models.ForeignKey(Comprobante, on_delete=models.CASCADE, related_name="emisor")
    ...
    RegimenFiscal_opcion = models.ForeignKey(OpcionCatalogoSAT, on_delete=models.SET_NULL, related_name="emisor_regimenfiscal", null=True, blank=True, limit_choices_to={'catalogo__idsat': 'RegimenFiscal'})
    created_by = models.ForeignKey(
        Usr, on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_by = models.ForeignKey(
...
class Receptor(models.Model):
    ...
    comprobante = models.ForeignKey(Comprobante, on_delete=models.CASCADE, related_name="receptor")
    Rfc = models.CharField(max_length=13)
    Nombre = models.CharField(max_length=254, null=True, blank=True)
    ResidenciaFiscal = models.CharField(max_length=25, null=True, blank=True)
    ResidenciaFiscal_txt = models.CharField(max_length=250, null=True, blank=True)
    ResidenciaFiscal_opcion = models.ForeignKey(OpcionCatalogoSAT, on_delete=models.SET_NULL, related_name="receptor_residenciafiscal", null=True, blank=True, limit_choices_to={'catalogo__idsat': 'ResidenciaFiscal'})
    ...
    UsoCFDI_opcion = models.ForeignKey(OpcionCatalogoSAT, on_delete=models.SET_NULL, related_name="receptor_usocfdi", null=True, blank=True, limit_choices_to={'catalogo__idsat': 'UsoCFDI'})
    created_by = models.ForeignKey(
        Usr, on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_by = models.ForeignKey(
...
class Conceptos(models.Model):
    ...
    comprobante = models.ForeignKey(Comprobante, on_delete=models.CASCADE, related_name="nodo_conceptos")
    created_by = models.ForeignKey(
        Usr, on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_by = models.ForeignKey(
...
class Concepto(models.Model):
    ...
    conceptos = models.ForeignKey(Conceptos, on_delete=models.CASCADE, related_name="conceptos")
    ClaveProdServ = models.CharField(max_length=25)
    ClaveProdServ_txt = models.CharField(max_length=250)
    ClaveProdServ_opcion = models.ForeignKey(OpcionCatalogoSAT, on_delete=models.SET_NULL, related_name="concepto_claveprodserv", null=True, blank=True, limit_choices_to={'catalogo__idsat': 'ClaveProdServ'})
    NoIdentificacion = models.CharField(max_length=100, null=True, blank=True)
    ...
    ClaveUnidad_opcion = models.ForeignKey(OpcionCatalogoSAT, on_delete=models.SET_NULL, related_name="concepto_claveunidad", null=True, blank=True, limit_choices_to={'catalogo__idsat': 'ClaveUnidad'})
    ...
    Descuento = models.DecimalField(max_digits=13, decimal_places=6, null=True, blank=True)
    created_by = models.ForeignKey(
        Usr, on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_by = models.ForeignKey(
...
class CImpuestos(models.Model):
    ...
    concepto = models.ForeignKey(Concepto, on_delete=models.CASCADE, related_name="nodo_cimpuestos", null=True, blank=True)
    created_by = models.ForeignKey(
        Usr, on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_by = models.ForeignKey(
...
class CTraslados(models.Model):
    ...
    cimpuestos = models.ForeignKey(CImpuestos, on_delete=models.CASCADE, related_name="nodo_ctraslados")
    created_by = models.ForeignKey(
        Usr, on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_by = models.ForeignKey(
...
class CTraslado(models.Model):
    """
    Nodo requerido para asentar la información detallada de un trasladado de impuestos aplicable al presente concepto
    """
    idctraslado = models.AutoField(primary_key=True)
    ctraslados = models.ForeignKey(CTraslados, on_delete=models.CASCADE, related_name="ctraslados")
    ...
    Impuesto_opcion = models.ForeignKey(OpcionCatalogoSAT, on_delete=models.SET_NULL, related_name="ctraslado_impuesto", null=True, blank=True, limit_choices_to={'catalogo__idsat': 'Impuesto'})
    TipoFactor = models.CharField(max_length=25)
    TipoFactor_txt = models.CharField(max_length=250)
    TipoFactor_opcion = models.ForeignKey(OpcionCatalogoSAT, on_delete=models.SET_NULL, related_name="ctraslado_tipofactor", null=True, blank=True, limit_choices_to={'catalogo__idsat': 'TipoFactor'})
    TasaOCuota = models.DecimalField(max_digits=9, decimal_places=6, null=True, blank=True)
    Importe = models.DecimalField(max_digits=13, decimal_places=6, null=True, blank=True)
    created_by = models.ForeignKey(
        Usr, on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_by = models.ForeignKey(
...
class CRetenciones(models.Model):
    ...
    cimpuestos = models.ForeignKey(CImpuestos, on_delete=models.CASCADE, related_name="nodo_cretenciones")
    created_by = models.ForeignKey(
        Usr, on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_by = models.ForeignKey(
...
class CRetencion(models.Model):
    ...
    cretenciones = models.ForeignKey(CRetenciones, on_delete=models.CASCADE, related_name="cretenciones")
    Base = models.DecimalField(max_digits=13, decimal_places=6)
    Impuesto = models.CharField(max_length=25)
    Impuesto_txt = models.CharField(max_length=250)
    Impuesto_opcion = models.ForeignKey(OpcionCatalogoSAT, on_delete=models.SET_NULL, related_name="cretencion_impuesto", null=True, blank=True, limit_choices_to={'catalogo__idsat': 'Impuesto'})
    TipoFactor = models.CharField(max_length=25)
    TipoFactor_txt = models.CharField(max_length=250)
    TipoFactor_opcion = models.ForeignKey(OpcionCatalogoSAT, on_delete=models.SET_NULL, related_name="cretencion_tipofactor", null=True, blank=True, limit_choices_to={'catalogo__idsat': 'TipoFactor'})
...
class CuentaPredial(models.Model):
    ...
    concepto = models.ForeignKey(Concepto, on_delete=models.CASCADE, related_name="cuentasprediales")
...
class ComplementoConcepto(models.Model):
    ...
    concepto = models.ForeignKey(Concepto, on_delete=models.CASCADE, related_name="complementos")
    created_by = models.ForeignKey(
        Usr, on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_by = models.ForeignKey(
...
class Parte(models.Model):
    ...
    concepto = models.ForeignKey(Concepto, on_delete=models.CASCADE, related_name="partes")
    ClaveProdServ = models.CharField(max_length=25)
    ClaveProdServ_txt = models.CharField(max_length=250)
    ClaveProdServ_opcion = models.ForeignKey(OpcionCatalogoSAT, on_delete=models.SET_NULL, related_name="parte_claveprodserv", null=True, blank=True, limit_choices_to={'catalogo__idsat': 'ClaveProdServ'})
    NoIdentificacion = models.CharField(max_length=100, null=True, blank=True)
    Cantidad = models.DecimalField(max_digits=12, decimal_places=6)
    Unidad = models.CharField(max_length=20, null=True, blank=True)
    Descripcion = models.CharField(max_length=1000)
    ValorUnitario = models.DecimalField(max_digits=13, decimal_places=6, null=True, blank=True)
    Importe = models.DecimalField(max_digits=13, decimal_places=6, null=True, blank=True)
    created_by = models.ForeignKey(
        Usr, on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
    created_at = models.DateTimeField(auto_now_add=True)
...
class InformacionAduanera(models.Model):
    ...
    Concepto
    Parte
        Nodo opcional para introducir la información aduanera aplicable cuando se trate de ventas de primera mano de mercancias importadas o se trate de operaciones de comercio exterior con bienes o servicios
    """
    idinformacionaduanera = models.AutoField(primary_key=True)
    concepto = models.ForeignKey(Concepto, on_delete=models.CASCADE, related_name="cinformacionesaduaneras", null=True, blank=True)
    parte = models.ForeignKey(Parte, on_delete=models.CASCADE, related_name="pinformacionesaduaneras", null=True, blank=True)
...
class Impuestos(models.Model):
    ...
    comprobante = models.ForeignKey(Comprobante, on_delete=models.CASCADE, related_name="nodo_impuestos", null=True, blank=True)
    TotalImpuestosRetenidos = models.DecimalField(max_digits=13, decimal_places=6, null=True, blank=True)
    TotalImpuestosTrasladados = models.DecimalField(max_digits=13, decimal_places=6, null=True, blank=True)
    created_by = models.ForeignKey(
        Usr, on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_by = models.ForeignKey(
...
class Traslados(models.Model):
    ...
    impuestos = models.ForeignKey(Impuestos, on_delete=models.CASCADE, related_name="nodo_traslados")
    created_by = models.ForeignKey(
        Usr, on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_by = models.ForeignKey(
...
class Traslado(models.Model):
    """
    Nodo requerido para la información detallada de un trasladado de impuesto específico
    """
    idtraslado = models.AutoField(primary_key=True)
    traslados = models.ForeignKey(Traslados, on_delete=models.CASCADE, related_name="trasladados")
    Impuesto = models.CharField(max_length=25)
    Impuesto_txt = models.CharField(max_length=250)
    Impuesto_opcion = models.ForeignKey(OpcionCatalogoSAT, on_delete=models.SET_NULL, related_name="traslado_impuesto", null=True, blank=True, limit_choices_to={'catalogo__idsat': 'Impuesto'})
    TipoFactor = models.CharField(max_length=25)
    TipoFactor_txt = models.CharField(max_length=250)
    TipoFactor_opcion = models.ForeignKey(OpcionCatalogoSAT, on_delete=models.SET_NULL, related_name="traslado_tipofactor", null=True, blank=True, limit_choices_to={'catalogo__idsat': 'TipoFactor'})
    TasaOCuota = models.DecimalField(max_digits=9, decimal_places=6)
    Importe = models.DecimalField(max_digits=13, decimal_places=6)
    created_by = models.ForeignKey(
        Usr, on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
...
class Retenciones(models.Model):
    ...
    impuestos = models.ForeignKey(Impuestos, on_delete=models.CASCADE, related_name="nodo_retenciones")
    created_by = models.ForeignKey(
        Usr, on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_by = models.ForeignKey(
...
class Retencion(models.Model):
    ...
    retenciones = models.ForeignKey(Retenciones, on_delete=models.CASCADE, related_name="retenciones")
    Impuesto = models.CharField(max_length=25)
    Impuesto_txt = models.CharField(max_length=250)
    Impuesto_opcion = models.ForeignKey(OpcionCatalogoSAT, on_delete=models.SET_NULL, related_name="retencion_impuesto", null=True, blank=True, limit_choices_to={'catalogo__idsat': 'Impuesto'})
    Importe = models.DecimalField(max_digits=13, decimal_places=6)
    created_by = models.ForeignKey(
        Usr, on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
    created_at = models.DateTimeField(auto_now_add=True)
...
class Complemento(models.Model):
    ...
    comprobante = models.ForeignKey(Comprobante, on_delete=models.CASCADE, related_name="complementos")
    created_by = models.ForeignKey(
        Usr, on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_by = models.ForeignKey(
...
class Addenda(models.Model):
    ...
    comprobante = models.ForeignKey(Comprobante, on_delete=models.CASCADE, related_name="addendas")
    created_by = models.ForeignKey(
        Usr, on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_by = models.ForeignKey(
