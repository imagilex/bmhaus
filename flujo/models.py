...
class Estado(models.Model):
    ...
    flujo = models.ForeignKey(Flujo, on_delete=models.PROTECT, related_name="estados")
    nombre = models.CharField(max_length=250)
...
class Accion(models.Model):
    ...
    flujo = models.ForeignKey(Flujo, on_delete=models.PROTECT, related_name="acciones")
    nombre = models.CharField(max_length=250)
    estado_inicial = models.ForeignKey(Estado, on_delete=models.PROTECT, related_name="acciones_ejecutar")
    estado_final = models.ForeignKey(Estado, on_delete=models.PROTECT, related_name="acciones_ejecutadas")
    created_by = models.ForeignKey(
        Usr, on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_by = models.ForeignKey(
...
class InstanciaFlujo(models.Model):
    ...
    flujo = models.ForeignKey(Flujo, on_delete=models.PROTECT, related_name="instancias")
    tipo_instancia = models.CharField(max_length=250)
    estado_actual = models.ForeignKey(Estado, on_delete=models.PROTECT, related_name="instancias_en_estado")
...
class InstanciaHistoria(models.Model):
    ...
    instanciaflujo = models.ForeignKey(InstanciaFlujo, on_delete=models.PROTECT, related_name="historia")
    accion = models.ForeignKey(Accion, on_delete=models.PROTECT, related_name="instancias_aplicadoras")
    created_by = models.ForeignKey(
        Usr, on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_by = models.ForeignKey(
...
class InstanciaHistoriaDetalle(models.Model):
    ...
    instanciahistoria = models.ForeignKey(InstanciaHistoria, on_delete=models.PROTECT, related_name="historia_detalle")
    ...
    def __str__(self):
        return "{} ({})".format(self.tipo_documento_generado, self.iddocumento_generado)
    def __unicode__(self):
        return self.__str__()
