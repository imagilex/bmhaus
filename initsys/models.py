...
class Permiso(Permission):
    ...
    vista = models.CharField(max_length=100, null=True, blank=True)
...
class Usr(User):
    ...
    fotografia = models.ImageField(
        null=True, blank=True, upload_to=usr_upload_to)
...
class Setting(models.Model):
    ...
    tipo = models.CharField(
        blank=False, max_length=20, choices=TIPOS_SETTING, default=CADENA)
